...
<ul>
<li>Hero Section : Perkenalan visual yang dinamis dengan pesan sambutan utama.</li>
<li>About Section : Deskripsi mendalam mengenai identitas Yayasan Zulka.</li>
<li>Members : Menampilkan profil individu yang tergabung dalam komunitas.</li>
<li>Social Media : Integrasi tautan sosial media.</li>
<li>Gallery : Menampilkan foto-foto.</li>
</ul>

<h2>⚙️ Teknologi yang Digunakan</h2>

<p>Proyek ini dibangun menggunakan teknologi web standar untuk memastikan kecepatan akses dan kemudahan pemeliharaan :</p>
<ul>
<li>HTML5 : Sebagai fondasi utama struktur konten.</li>
<li>CSS3 : Untuk styling tata letak yang responsif dan elemen visual yang bersih.</li>
<li>JavaScript : Untuk memberikan interaktivitas pada elemen navigasi dan animasi sederhana.</li>
